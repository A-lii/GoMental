    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intt = new Intent(ReportsActivity.this,ReportsDetailsActivity.class);
                intt.putExtra("text1", packages[i][0]);
                intt.putExtra("text2", package_details[i]);
                intt.putExtra("text3", packages[i][4]);
                startActivity(intt);
            }
        });
    }
